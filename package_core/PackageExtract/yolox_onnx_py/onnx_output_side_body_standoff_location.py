...
def make_parser(img_path):
    ...
    parser.add_argument(
        ...
        "--model",
        type=str,
        default="yolox_onnx/BGA_side_body_standoff.onnx",
    ...
    parser.add_argument(
        ...
        "--output_dir",
        type=str,
        default='onnx_output/BGA_side_body_standoff.onnx',
...
def begain_output_side_body_standoff_location(img_path):
    """封装入口：输出侧视本体/垫高检测结果。"""
    global OTHER
    global GUANGJIEDU
    OTHER = np.zeros((0,4))
