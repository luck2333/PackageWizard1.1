...
def get_SOP_parameter_list(top_ocr_data, bottom_ocr_data, side_ocr_data, detailed_ocr_data, body_x, body_y):
    ...
    SOP_parameter_list.append(dic_Φ)
    ...
    for i in range(len(bottom_ocr_data)):
        ...
        if has_phi or bottom_ocr_data[i].get('Absolutely') == 'pin_diameter':
            SOP_parameter_list[17]['maybe_data'].append(bottom_ocr_data[i])
            SOP_parameter_list[17]['maybe_data_num'] += 1
